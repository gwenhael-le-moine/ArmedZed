...
* Apparently tslib doesn't like chvt (switching from X to consle) and therefore exiting X hang the Z ( http://www.mail-archive.com/zaurus-devel@lists.linuxtogo.org/msg00087.html ).
